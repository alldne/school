...
namespace School.Surface
{
    ...
    public class Gte: BinaryOperator
    {
        public Gte(Expr left, Expr right) : base(left, right) { }
    ...
    public class Lte : BinaryOperator
    {
        public Lte(Expr left, Expr right) : base(left, right) { }
